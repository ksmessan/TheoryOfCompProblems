...
function generateTransitionFunctions() {
  ...
  //each transition can be done from any state, so the below function describes the total number of states
...
function generateAcceptingSets() {
  ...
  //there are 2^n subsets of n states (each state can eitehr be accepting or not)
